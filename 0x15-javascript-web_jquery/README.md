...
This project served as a preparatory phase for acquiring skills in manipulating the Document Object Model (DOM) using jQuery, in advance of its integration into our HolbertonBnB project.
